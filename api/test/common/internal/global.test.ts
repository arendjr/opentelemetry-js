...
import { getGlobal } from '../../../src/internal/global-utils.ts';
import { _globalThis } from '../../../src/platform/index.ts';
import { NoopContextManager } from '../../../src/context/NoopContextManager.ts';
import { DiagLogLevel } from '../../../src/diag/types.ts';
import sinon = require('sinon');

const api1 = require('../../../src') as typeof import('../../../src/index.ts');

// clear cache and load a second instance of the api
for (const key of Object.keys(require.cache)) {
  delete require.cache[key];
}
const api2 = require('../../../src') as typeof import('../../../src/index.ts');
